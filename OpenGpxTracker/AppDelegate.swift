...
//        var temp : NSDictionary = userInfo
        ...
        {
            if var alertMsg = info["alert"] as? Dictionary<String, AnyObject>
            {
            let alertTitle = "\(alertMsg["title"])"
            let alertMessage = "\(alertMsg["body"])"
            var alert: UIAlertView!
            alert = UIAlertView(title: alertTitle, message: alertMessage, delegate: nil, cancelButtonTitle: "OK")
            alert.show()
            }
            else{
                let alertMessage = "\(info["alert"])"
                var alert: UIAlertView!
                alert = UIAlertView(title: "", message: alertMessage, delegate: nil, cancelButtonTitle: "OK")
                alert.show()
            }
        }
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Fabric.with([MoPub.self, Crashlytics.self])
